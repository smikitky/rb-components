  ...
  return (
    <div>
      ...
      <ul>
        ...
        <li>
          <LoadingIndicator icon="repeat" />
        </li>
        <li>
          <LoadingIndicator icon="fa-spinner" />
        </li>
        <li>
      ...
      <ul>
        ...
        <li>
          <LoadingIndicator icon="repeat" delay={1000} />
        </li>
        <li>
          <LoadingIndicator icon="fa-spinner" delay={1500} />
        </li>
        <li>
          <LoadingIndicator icon="fa-cog" delay={2000} />
        </li>
      </ul>
    </div>
  );
