...
const createDialog = WrappedComponent => {
  const Enhanced = class extends React.Component {
    constructor(props) {
      ...
      this.handleHide = this.handleSettle.bind(this, true, null);
    ...
    render() {
      const { bsSize, backdrop, className, keyboard, ...rest } = this.props;
      return (
        <Modal
 ...
 * @param {React.Component} DialogContent The dialog content component.
...
export const modal = (
  DialogContent,
  { bsSize, backdrop = 'static', className, keyboard = true } = {}
) => {
...
export const alert = (
  text,
  { title = 'Message', icon = 'info-sign', cancelable = true, bsSize } = {}
) => {
  const buttons = { OK: { response: true, style: 'primary', autoFocus: true } };
  return choice(text, buttons, { title, icon, cancelable, bsSize });
};
...
export const confirm = (
  text,
  { title = 'Confirm', icon = 'info-sign', cancelable = true, bsSize } = {}
) => {
  const buttons = {
...
export const choice = (
  text,
  choices,
  { title = 'Choose', icon = 'info-sign', cancelable = false, bsSize } = {}
) => {
